...
cp -pf $iccid_xml_13 $phone_iccid_path/ICCID_backup_1.xml
ui_print "> ICCID XML backup:ICCID_backup_1.xml"
ui_print "> ICCID XML 备份:ICCID_backu_1.xml"
#################################################################################
IFS=$'\n'
...
xml_iccid_edit_line() {
	...
	do
		...
		then
			...
			echo "修改行数: $print_ui_1 - $print_ui_1 = $((print_ui_1 - print_ui_0))"
			ui_print "> Modify the number of lines: $print_ui_1 - $print_ui_1 = $((print_ui_1 - print_ui_0))"
			ui_print "> 修改行数: $print_ui_1 - $print_ui_1 = $((print_ui_1 - print_ui_0))"
		fi
    done
}
################################################################################################
...
print_ui_0=`cat $iccid_xml_13 | wc -l`
print_ui_1=`cat $MODPATH$iccid_xml_13 | wc -l`
